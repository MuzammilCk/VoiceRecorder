...
// Provides high-accuracy transcription with speaker diarization
...
class AssemblyAIService {
    ...
    private baseUrl = '/assemblyai'; // via Next.js proxy
...
// Create service instance (reads NEXT_PUBLIC_ASSEMBLYAI_API_KEY from .env by default)
